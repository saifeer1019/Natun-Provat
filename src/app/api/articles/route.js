  ...
  try {
    ...
    let limit = 8
     ...
     const featuredNews = await Article.find({'isFeatured':true,})
      ...
      const রাজশাহী = await getCategories('রাজশাহী', 6);
      const বিনোদন = await getCategories('বিনোদন', 4);
      const খেলাধুলা = await getCategories('খেলাধুলা', 4);
      const বিশ্ব = await getCategories('বিশ্ব', 4);
      const বাংলাদেশ = await getCategories('বাংলাদেশ', 4);
